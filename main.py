...
class MainWidget(RelativeLayout):
    ...
    def update_ship(self):
        ...
        half_width_ship = self.SHIP_WIDTH * self.width / 2
        
        pt_x1 = center_x - half_width_ship
        pt_y1 = base_y
        pt_x2 = center_x
        pt_y2 = base_y + self.SHIP_HEIGHT * self.height
        pt_x3 = center_x + half_width_ship
        pt_y3 = base_y
        
        self.ship_coordinates[0] = (pt_x1, pt_y1)
        self.ship_coordinates[1] = (pt_x2, pt_y2)
        self.ship_coordinates[2] = (pt_x3, pt_y3)
        
        x1, y1 = self.transform(pt_x1, pt_y1)
        x2, y2 = self.transform(pt_x2, pt_y2)
        x3, y3 = self.transform(pt_x3, pt_y3)
    ...
    def get_line_x_from_index(self, index):
        ...
        offset = index - 0.5
        line_x = central_line_x + spacing*offset + self.current_offset_x
        return line_x
